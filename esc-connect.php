...
function wp_ms365_register_editor_blocks() {
	...
	$block_definitions = array(
		...
		'esc-connect/sharepoint-library' => array(
		...
		'esc-connect/login-button' => array(
...
function wp_ms365_graph_activate() {
	$defaults = array(
		...
		'redirect_uri'  => admin_url( 'admin.php?page=esc-connect' ),
